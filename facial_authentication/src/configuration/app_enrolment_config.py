...
class _AppConfiguration:
	def __init__(self):
		...
		config = {
			...
			# TODO: WIP, currently not in used
			# 	For long enrolment, how many enrols should be completed before a face is confirmed?
			"enroll_best_out_of": 3,
			# TODO: WIP, currently not in used
			# 	For long enrolment, the min required score the enrolling faces must hit, if not the app will keep re-enrolling
			"min_long_enroll_score_threshold": 3000,
		}
		# Dynamic calculation
