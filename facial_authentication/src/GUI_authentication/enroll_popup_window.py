...
class EnrollPopupWindow(tk.Toplevel):
	def __init__(self, parent):
		...
		self.geometry("%dx%d+%d+%d" % (400, 150, x+50, y+50))
		...
		self.employee_id_entry = tk.Entry(self, textvariable=self.emp_id_tk_str_var, width=20)
		self.employee_id_entry.pack(ipady=5)
