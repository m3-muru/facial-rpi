...
if __name__ == '__main__':
    # Uncomment to remove hardcoded system args
    sys.argv.append("Ong Ye Kung")
    sys.argv.append("./sample_user/ong_ye_kung.jpg")
    # sys.argv.append("Lim Wee Kiak")
    # sys.argv.append("./sample_user/lim_wee_kiak.jpg")
